...
<div class="container col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12" style='min-width:300px;'>
	<div class="panel panel-default">
		...
		<?php 
			...
			echo "<div class='clearfix'>".$this->Form->input('image_path', array('disabled', 'class' => 'pull-right','style'=>'resize:none;','label' => array('class'=>'control-label','text'=>__('Image Path').':'), 'default'=>__($assocModel['path'])))."</div>"; 
			echo "<div class='clearfix'><div class='pull-right'><input type='file' name='data[".$model."][file][image]' id='FileImage' style='width:95px;' /></div></div>";
			$options = array(
				'div' => false,
				'label' => __('Save'),
