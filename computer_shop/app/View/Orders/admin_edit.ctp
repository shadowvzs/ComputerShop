<div class="col-md-8 col-md-offset-2">
	<div class="panel panel-default">
		...
		echo "<div class='clearfix'>".$this->AdvForm->selectOnOff('active',$order['active'],array("Refused","Active"))."</div>";
		echo "<div class='clearfix'>".$this->Form->input('status', array('class' => 'pull-right','style'=>'width: 150px;resize:none;','label' => array('class'=>'control-label','text'=>__('Status').':'), 'options' => $status, 'default'=>$order['status']))."</div>";
